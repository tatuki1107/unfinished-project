...
test('mail endpoints validate input, protect origin, use signup resend and handle provider failures',async()=>{
 ...
 const auth={resend:async input=>{calls.push(input);return {error};},resetPasswordForEmail:async email=>{calls.push(email);return {error};}};
 ...
 try{
  ...
  assert.deepEqual(calls[0],{type:'signup',email:'mail@example.com'});
